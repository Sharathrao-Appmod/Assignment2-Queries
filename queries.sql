Linux new-instance-sharath 5.10.0-27-cloud-amd64 #1 SMP Debian 5.10.205-2 (2023-12-31) x86_64
...
sample-sharth=> CREATE USER sharath WITH PASSWORD 'niveus@123';
CREATE ROLE
sample-sharth=> CREATE DATABASE employee1;
CREATE DATABASE
sample-sharth=> ALTER ROLE sharath SET client_encoding TO 'utf8';
ALTER ROLE
sample-sharth=> ALTER ROLE sharath SET default_transaction_isolation TO 'read committed';
ALTER ROLE
sample-sharth=> ALTER ROLE sharath SET timezone TO 'UTC';
ALTER ROLE
sample-sharth=> GRANT ALL PRIVILEGES ON DATABASE employee1 TO sharath;
GRANT
sample-sharth=> GRANT ALL ON SCHEMA public TO sharath;
GRANT
sample-sharth=> GRANT ALL PRIVILEGES ON TABLE COMPANY TO sharath;
GRANT
sample-sharth=> \l
                                                  List of databases
       Name       |       Owner       | Encoding |  Collate   |   Ctype    |            Access privileges            
...
CREATE TABLE
employee1=> CREATE TABLE DEPARTMENT(
                    ID INT PRIMARY KEY      NOT NULL,
